	...
	export const tutorial = [
		{
			...
			img:
				'https://images.unsplash.com/photo-1522937335625-b87ea99dc133?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80',
			date: 'July 19, 2021'
		},
		{
			title: 'How to share your UPI ID via scannable QR code',
			preview: '',
			...
			img:
				'https://images.unsplash.com/photo-1530989166579-96a5923c8ce5?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1951&q=80',
			date: 'July 20, 2021'
		},
		{
			title: 'How to change six digit UPI pin',
			preview: '',
			...
			img:
				'https://images.unsplash.com/photo-1504203700686-f21e703e5f1c?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1961&q=80',
			date: 'July 21, 2021'
		},
		{
			title: 'How to check account balance of linked account(s)',
			preview: '',
			...
			img:
				'https://images.unsplash.com/photo-1565373679107-344d38dbf734?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80',
			date: 'July 22, 2021'
		},
		{
			title: 'How to pay bills',
			preview: '',
			content: `<ul><li>Step 1 : Click on <code>New Payments</code> on the home screen of the app.</li><li>Step 2: Now, click on the <code>Bill Payments</code> option.</li><li>Step 3 : Click on <code>Electricity</code>.</li><li>Step 4 : Select your Electricity Supply Corporation. You will see that no account has been linked yet. </li><li>Step 5 : To link your account, Click on <code>Get Started</code>.</li><li>Step 6 : Enter your 10-digit Account ID. You can find this in your electricity bill.</li><li>Step 7 : Enter your <code>Account Name</code>. Note that this is for your own reference. You may, however, skip this field.</li><li>Step 8 : Check whether the information you have entered is correct.</li><li>Step 9 : Now, click on the <code>Link Account</code> option. Once this is done, you will see that your account has been linked and your most recent bill is displayed.</li><li>Step 10 : You can verify this amount with your electricity bill.</li><li>Step 11 : To make the payment, click on <code>Pay Bill</code>.</li><li>Step 12 : Select the bank account for making the payment and click on <code>Proceed to Pay</code>.</li><li>Step 13: Follow the steps of making a payment. This is similar to a normal transaction you would make.</li><li>Step 14: Your electricity bill is paid. Similarly, you can pay bills for other services like Cable, LPG, Broadband and many more. </li></ul>`,
			img:
				'https://images.unsplash.com/photo-1545941962-1b6654eb8072?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1900&q=80',
			date: 'July 23, 2021'
		},
		{
			...
			img:
				'https://images.unsplash.com/photo-1559131397-f94da358f7ca?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80',
			date: 'July 24, 2021'
		},
		{
			...
			img:
				'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1789&q=80',
			date: 'July 25, 2021'
		},
		{
			...
			img:
				'https://images.unsplash.com/photo-1462045504115-6c1d931f07d1?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1951&q=80',
			date: 'July 26, 2021'
		},
		{
			...
			img:
				'https://images.unsplash.com/photo-1550482768-88b710a445fd?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1868&q=80',
			date: 'July 27, 2021'
		},
		{
			...
			img:
				'https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1971&q=80',
			date: 'July 28, 2021'
		}
	];
</script>
